...
from osim.env.armMoBL import Arm3DVecEnv
from osim.env.armMonk import Arm3DVecMonkEnv
...
# env = Arm3DVecEnv(args.visualize)
env = Arm3DVecEnv(args.visualize)
# env = Arm3DVecMonkEnv(args.visualize)
env.reset()
#env.reset(verbose=True, logfile='arm_log.txt')
...
if not args.train:
    env = Arm3DVecEnv(visualize = True)
    # env = Arm3DVecMonkEnv(args.visualize)
    env.reset()
